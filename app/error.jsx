    ...
    <div>
      <div class="flex h-[calc(100vh-80px)] items-center justify-center p-5 w-full bg-white">
        <div class="text-center">
          ...
          <h1 class="mt-5 text-[36px] font-bold text-slate-800 lg:text-[50px]">{error.message}</h1>
          ...
          <div className="mt-2">
            <button onClick={reset} type="button" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
              Try again!
            </button>
          </div>  
        </div>
