...
function List() {
    ...
    const records = Data.colon_cancer.slice(firstIndex, lastIndex)
    ...
    return (
        <div>
            <div className="flex justify-center items-center mt-8 mb-16">
                <p className="text-blue-500 text-3xl font-semibold">Colon Cancer</p>
            </div>
                                ...
                                <tr key={item.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td scope="col" className="px-6 py-4">
                                        ...
                                        <button onClick={() => setShowModalEdit(true)} >
                                            <svg className="w-[15px] h-[15px] text-blue-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
